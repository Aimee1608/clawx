...
export interface SheetContentProps
  ...
  /** When true, suppress the built-in top-right close button. Use this
   * when the consumer renders its own close affordance (e.g. a back
   * arrow inside a sticky header). */
